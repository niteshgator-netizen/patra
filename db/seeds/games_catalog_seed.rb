# Seeds the master games catalog with 25 sweepstakes games.
# Run with: bundle exec rails runner db/seeds/games_catalog_seed.rb
# Safe to run multiple times — uses find_or_initialize_by.
...
games.each do |attrs|
  ...
  game.save!
  puts "✓ #{game.name} (#{game.slug})"
end

puts "\nSeeded #{Game.count} games into catalog."
