...
- [ ] D1 DISCOVER real persisted intent signal (read-only)
- [ ] D2 Aggregation source: existing API or new read-only endpoint
- [ ] D3 Render spec section in PatraOwnerDashboard (real data, hidden when empty)
...
- [ ] Q1 Programmatic sweeps (bare dark tokens, rogue hex, z-index, transitions, focus-visible)
- [ ] Q2 PATRA_UI_AUDIT.md + final build green. STOP.
