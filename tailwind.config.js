  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'auth-surface-2': 'var(--auth-surface-2)',
        'auth-surface-3': 'var(--auth-surface-3)',
        'auth-border': 'var(--auth-border)',
        'auth-border-hi': 'var(--auth-border-hi)',
        'auth-text': 'var(--auth-text)',
        'auth-text-dim': 'var(--auth-text-dim)',
        'auth-text-mute': 'var(--auth-text-mute)',
        'auth-input-bg': 'var(--auth-input-bg)',
        'auth-card-bg': 'var(--auth-card-bg)',
        'auth-nav-bg': 'var(--auth-nav-bg)',
      },
      boxShadow: {
