json.data do
  ...
  json.payload do
    json.array! @notifications do |notification|
      ...
      json.primary_actor Patra::ContactPrivacy.event_data_for(notification.primary_actor, Current.account_user)
      json.read_at notification.read_at
      # Secondary actor could be nil for cases like system assigning conversation
      json.secondary_actor Patra::ContactPrivacy.event_data_for(notification.secondary_actor, Current.account_user)
