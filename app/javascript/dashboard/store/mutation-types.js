export default {
  ...
  // User Viewing (collision detection)
  ADD_USER_VIEWING_TO_CONVERSATION: 'ADD_USER_VIEWING_TO_CONVERSATION',
  REMOVE_USER_VIEWING_FROM_CONVERSATION: 'REMOVE_USER_VIEWING_FROM_CONVERSATION',
