export const twilioTemplates = [
  ...
  {
    body: 'What type of Chatwoot installation are you using? Select "Patra Cloud" if you are using app.chatwoot.com, otherwise select "Self-hosted Patra".',
    types: {
      'twilio/quick-reply': {
        body: 'What type of Chatwoot installation are you using? Select "Patra Cloud" if you are using app.chatwoot.com, otherwise select "Self-hosted Patra".',
        actions: [
          {
            id: 'Patra Cloud_payload',
            title: 'Patra Cloud',
          },
          {
            id: 'Self-hosted Patra_payload',
            title: 'Self-hosted Patra',
          },
        ],
      },
    },
