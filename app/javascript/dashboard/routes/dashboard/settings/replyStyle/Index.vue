<template>
  <div class="flex-1 overflow-auto p-6">
    <div class="max-w-2xl">
      ...
      <p class="text-sm text-slate-400 mb-6">Control how Bella replies to customers.</p>
      ...
      <div v-else class="space-y-6">
        <label class="block">
          ...
          <select v-model="pref.reply_tone" class="w-full mt-1 p-2 bg-slate-800 border border-slate-600 rounded text-sm">
        ...
        <label class="block">
          ...
          <input v-model.number="pref.max_reply_lines" type="number" min="1" max="10" class="w-24 mt-1 p-2 bg-slate-800 border border-slate-600 rounded text-sm" />
        </label>

        <label class="block">
          <span class="text-sm">Sign-off text</span>
          <input v-model="pref.sign_off_text" type="text" placeholder="e.g. - Bella, xo, etc." class="w-full mt-1 p-2 bg-slate-800 border border-slate-600 rounded text-sm" />
        </label>
        ...
        <label class="block">
          ...
          <input v-model.number="pref.rag_example_count" type="number" min="1" max="10" class="w-24 mt-1 p-2 bg-slate-800 border border-slate-600 rounded text-sm" />
        </label>
