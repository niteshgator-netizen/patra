    ...
    <div class="pat-page-main">
      <div class="flex flex-col gap-4 p-6">
        <h1 class="text-2xl font-semibold">
          {{ $t('PATRA.ATTRIBUTES.TITLE') }}
        </h1>
        <p class="text-sm text-n-slate-11">
          {{ $t('PATRA.ATTRIBUTES.SUBTITLE') }}
        </p>
        ...
        <div class="flex gap-2 p-3 border rounded-lg border-n-weak">
          <input
            ...
            class="flex-1 p-2 text-sm border rounded-lg border-n-weak"
            :placeholder="$t('PATRA.ATTRIBUTES.LABEL')"
          />
          <select
            v-model="newField.type"
            class="p-2 text-sm border rounded-lg border-n-weak"
          >
